...
uint256 hashGenesisBlock("b069f8ff708ee6193a04bdd55b0fefb8e95af9ca73ea3b33c931f1300a237265");
...
const string strMessageMagic = "KaoriCoin Signed Message:\n";
...
{
    int64 nSubsidy = 201 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // KaoriCoin: 1 days
static const int64 nTargetSpacing = 120; // KaoriCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal kaoricoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "KaoriCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("4642a8fd3d40d1ca1ef8799c0fdc0c8199bca2a54aedff7729ddd9d854fc97d6");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1511802222; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 382524;

        if (fTestNet)
        {
            block.nTime    = 1511405538;
            block.nNonce   = 2430632;
        }
